...
public class VagaRestController {
	...
	// criar metodo que lista vaga por AreaProfissional *perguntar se é para listar em ordem de areaProfissional ou é para fazer uma busca por areaProfissional
